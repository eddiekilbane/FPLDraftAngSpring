package fpl.draftpick.config.root;


import fpl.draftpick.app.init.TestDataInitializer;
...
public class DevelopmentConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DriverManagerDataSource dataSource) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"fpl.draftpick.app.model"});
